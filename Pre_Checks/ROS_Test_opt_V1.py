...
def main():
    ...
    while(not rospy.is_shutdown() ) :
        if(time.perf_counter()-t1 <= 3):
            ...
            template = "{{'Sys_time': {}, 'Ctrl_time': {}, 'ang_vel':{}, 'Sigma': {}, 'mu2':{},'Kbar': {} }}".format(
                (time.perf_counter()-t1), final_op['time'], final_op['ang_vel'], final_op['sigma'], final_op['mu2'],final_op['kbar'])          

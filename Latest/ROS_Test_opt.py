...
def main():
    ...
    while(not rospy.is_shutdown() ) :
        if(time.perf_counter()-t1 <= 10):
            ...
            template = "{{'Sys_time': {}, 'Ctrl_time': {}, 'ang_vel':{}, 'Sigma': {}, 'torq':{}, 'Kbar': {} }}".format(
                (time.perf_counter()-t1), final_op['time'], final_op['ang_vel'], final_op['sigma'], final_op['torq'], final_op['kbar'])          
